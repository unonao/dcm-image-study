...
class Pelvis extends Component {
    state = {
        ...
        //first
        first_imageIds: img_list,
        first_imageNames: img_list_name,
        firstIndex:0,
        first_imageIndex: 0,
        //second
        second_imageIds: img_list,
        second_imageNames: img_list_name,
        secondIndex:0,
        second_imageIndex: 0,
        //third
        third_imageIds: img_list,
        third_imageNames: img_list_name,
        thirdIndex:0,
        third_imageIndex: 0,
